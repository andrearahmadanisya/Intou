...
<head>
    ...
    <title>IntoU | History Data Buku</title>
                            ...
                            <tbody>
                                ...
                                foreach ($buku as $hbk) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo $hbk['idbuku'] ?></td>
                                        <td class="text-center"><?php echo $hbk['judul'] ?></td>
                                        <td class="text-center"><?php echo $hbk['category'] ?></td>
                                        <td class="text-center"><?php echo $hbk['penulis'] ?></td>
                                        <td class="text-center"><?php echo $hbk['tglmasuk'] ?></td>
                                        <td class="text-center"><?php echo $hbk['hargajual'] ?></td>
                                        <td class="text-center"><?php echo $hbk['hargabeli'] ?></td>
                                        <td class="text-center"><?php echo $hbk['total'] ?></td>
                                        <td class="text-center">
                                            <button class="btn btn-success btn-sm rounded-0" type="button" data-toggle="modal" data-target="#Updatehbk<?= $hbk['idbuku'] ?>" title="Edit"><i class="fa fa-edit"></i></button>
                                            <a class="btn btn-danger btn-sm rounded-0" type="button" href="<?php echo base_url() . 'BukuController/delete/' . $hbk['idbuku'] ?>" data-placement="top" title="Delete" onClick="return confirm('Apakah Anda Yakin?')"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
