    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
                ...
                <div class="row">
                    <div class="col">
                        <h4 class="h5 align-middle m-0 font-weight-bold " style="color: #315c9a;">
                            Form Edit Transaksi Buku Masuk
                        </h4>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                ...
                <?= form_open('', [], ['idtransaksi' => $transaksimsk['idtransaksi']], ['namasupplier' => $transaksimsk['idsupplier']]); ?>
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="idtransaksi">ID Transaksi buku Masuk</label>
                    <div class="col-md-4">
                        <input value="<?= set_value('idtransaksi', $transaksimsk['idtransaksi']); ?>" type="text" readonly="readonly" class="form-control">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <input value="<?= set_value('tanggal_masuk', date('l, d-m-Y'), $transaksimsk['tanggal_masuk']); ?>" name="tanggal_masuk" id="tanggal_masuk" type="text" class="form-control date" placeholder="Tanggal Masuk...">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            <select name="idsupplier" id="idsupplier" class="custom-select">
                                <option <?= set_value('idsupplier', $transaksimsk['idsupplier']); ?> value="<?= $transaksimsk['idsupplier']; ?>"><?= $transaksimsk['idsupplier'] ?></option>
                                <?php foreach ($supplier as $s) : ?>
                                    <option <?= set_select('idsupplier', $s['idsupplier']) ?> value="<?= $s['idsupplier'] ?>"><?= $s['idsupplier'] . ' | ' . $s['namasupplier'] ?></option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            <select name="id_buku" id="id_buku" class="custom-select">
                                <option value="" selected disabled><?= $transaksimsk['id_buku'] ?></option>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            <input value="<?= set_value('totalmasuk', $transaksimsk['totalmasuk']); ?>" name="totalmasuk" id="totalmasuk" type="number" class="form-control" placeholder="Jumlah Masuk...">
                            <div class="input-group-append">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <input value="<?= set_value('hargapcs', $transaksimsk['hargapcs']); ?>" name="hargapcs" id="hargapcs" type="text" class="form-control" placeholder="Harga Beli/pcs...">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <input value="<?= set_value('hargatotal', $transaksimsk['hargatotal']); ?>" name="hargatotal" id="hargatotal" type="text" class="form-control" placeholder="Harga Jual/pcs...">
